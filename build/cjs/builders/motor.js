...
exports.buildMotorCoverNoteXml = buildMotorCoverNoteXml;
const xmlbuilder2_1 = require("xmlbuilder2");
function buildMotorCoverNoteXml(payload, config) {
    ...
    return (0, xmlbuilder2_1.create)({ version: "1.0" })
        .ele({
        MotorCoverNoteRefReq: {
            ...
            CoverNoteDtl: {
                ...
                PrevCoverNoteReferenceNumber: payload.previous_covernote_reference_number ?? "",
                ...
                TotalPremiumExcludingTax: Number(payload.total_premium_excluding_tax).toFixed(2),
                TotalPremiumIncludingTax: Number(payload.total_premium_including_tax).toFixed(2),
                ...
                RisksCovered: {
                    RiskCovered: payload.risks_covered.map((r) => ({
                        ...
                        PremiumExcludingTaxEquivalent: Number(r.premium_excluding_tax_equivalent).toFixed(2),
                ...
                CoverNoteAddons: {
                    CoverNoteAddon: (payload.covernote_addons ?? []).map((a) => ({
                        ...
                        PremiumExcludingTaxEquivalent: Number(a.premium_excluding_tax_equivalent).toFixed(2),
