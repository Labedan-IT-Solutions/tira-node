...
exports.MotorResource = void 0;
const motor_js_1 = require("../validation/motor.js");
const motor_js_2 = require("../builders/motor.js");
class MotorResource {
    client;
    config;
    ...
    async submit(payload) {
        (0, motor_js_1.validateMotorCoverNotePayload)(payload);
        const xml = (0, motor_js_2.buildMotorCoverNoteXml)(payload, this.config);
...
exports.MotorResource = MotorResource;
